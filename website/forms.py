...
class AddRecordForm(forms.ModelForm):
    ...
    phone = forms.CharField(max_length=11, required=True, widget=forms.TextInput(attrs= { 'placeholder': 'Phone', 'class': 'form-control' }))
    ...
    zipcode = forms.IntegerField(required=True, widget=forms.TextInput(attrs= { 'placeholder': 'Zipcode', 'class': 'form-control' }))
